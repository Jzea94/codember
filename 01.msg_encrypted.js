...
// const animals = message.toLocaleLowerCase().split(' ')

// const array = []

// for (const animal of animals) {
//     const filtro = animals.filter(element => element === animal)
//     const item = filtro[0] + filtro.length
//     array.push(item)
// }

// const arrSinDuplicados = [... new Set(array)]
// const result = arrSinDuplicados.join('')

// console.log(result)

const animals = message.toLowerCase().split(' ');
...
const resultArray = Object.keys(countMap).map(animal => animal + countMap[animal]);
